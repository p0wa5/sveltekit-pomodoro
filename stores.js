...
pomoTimeStore.subscribe((val) => browser && localStorage.setItem("pomoTimeStore", val));
...
shortBreakTimeStore.subscribe((val) => browser && localStorage.setItem("shortBreakTimeStore", val));
...
longBreakTimeStore.subscribe((val) => browser && localStorage.setItem("longBreakTimeStore", val));
